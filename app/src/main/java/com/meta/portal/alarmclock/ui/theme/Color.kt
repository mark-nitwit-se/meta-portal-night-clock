...
package com.meta.portal.alarmclock.ui.theme
...
// Night mode — warm, low-blue-light palette on near-black to avoid disrupting sleep
val NightBackground = Color(0xFF000000)
val NightAmber = Color(0xFFFF7A1A)
val NightAmberDim = Color(0xFF8A3D00)
val NightOnSurface = Color(0xFFC25A12)
